...
ln -svf /usr/local/csf/bin/csfui.pl /etc/csf/
...
cp -avf csfui.pl /usr/local/csf/bin/
cp -avf csfuir.pl /usr/local/csf/bin/
cp -avf cseui.pl /usr/local/csf/bin/
cp -avf csftest.pl /usr/local/csf/bin/
cp -avf regex.pm /usr/local/csf/bin/
...
#    ln -svf /usr/local/csf/lib/cwp/ /etc/csf/
#	ln -svf /etc/csf/cwp /usr/local/cwpsrv/htdocs/admin/csf
#	ln -svf /etc/csf/cwp/cwp_csf_r.php /usr/local/cwpsrv/htdocs/resources/admin/modules/
#fi
